...
WARNING: This executes a real on-chain transaction.`,
      parameters: {
        ...
        properties: {
          ...
          fib500:                { type: "number",  description: "Fib 0.500 price level (SOL). Hard gate: current price must be >= this value" },
          ...
          has_hidden_divergence: { type: "boolean", description: "True if hidden bullish divergence was detected at entry" },
          smart_wallet_present:  { type: "boolean", description: "True if smart wallet boost was applied (fib_signal.confluenceScore was boosted +0.10)" },
        },
        required: ["pool_address"],
      },
    },
...
Returns summary stats + individual trade list. PnL is approximate (IL simplified, fees estimated).`,
      parameters: {
        ...
        properties: {
          ...
          preset:       { type: "string",  enum: ["fibonacci"], description: "Strategy preset to simulate. Default: current config." },
        },
...
Presets: fibonacci (Fibonacci + Volume Profile — single default strategy).`,
      parameters: { type: "object", properties: {} },
    },
  },
...
Available: fibonacci (single default — Fibonacci + Volume Profile).
